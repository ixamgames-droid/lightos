...
## 🔧 In Arbeit / Review
_(leer — der Loop trägt hier ein, was gerade läuft, inkl. Branch + PR-Link)_
...
| UI-02  | P1 | todo | Undo im Patch | Fixture-Löschen im Patch-View rückgängig (Ctrl+Z); Test für Undo/Redo |
