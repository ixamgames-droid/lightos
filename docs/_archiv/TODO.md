...
>
> **➡ 2026-06-10: Repo-weite Übersicht ALLER offenen Punkte (Bugs, Features,
> UI, Schulden, Fixture/DMX, Doku) in
> [docs/OPEN_POINTS_OVERVIEW.md](docs/OPEN_POINTS_OVERVIEW.md)** — dort steht
> auch, was die Moving-Head-Änderung 2026-06-10 (ZQ02001-Korrektur, Gobo-Tab,
> Farbrad-Kacheln, Reset-Button) bereits erledigt hat.
>
> **➡ 2026-06-08: Konsolidierter Gesamtplan in [docs/MASTERPLAN_2026-06-08.md](docs/MASTERPLAN_2026-06-08.md)**
> — gleicht den 34-Punkte-Auftrag ("Programmer/VC-Trennung, Matrix-Live, UI-Cleanup,
> Speed Dial, Folders, Fixtures/Demo") gegen den realen Code-Stand ab (✅/🟡/🔴) und
> enthält die thematischen To-dos (ISO/OUT/MXP/MLV/SPD/BTN/FRM/FLD/SNP/LIB/DMO/SAV/UIC/TST)
> samt Prioritäten, Abhängigkeiten und Roadmap-Phasen 0–6.
...
- [ ] **Spider-Köpfe getrennt einfärben + 3D-Modell** (Nutzerwunsch 2026-06-14) → Plan, betroffene Dateien und 3D-Modell-Quellen in [docs/SPIDER_MULTIHEAD_TODO.md](docs/SPIDER_MULTIHEAD_TODO.md); auch als X-6 in [docs/OPEN_POINTS_OVERVIEW.md](docs/OPEN_POINTS_OVERVIEW.md). (Die Dani-Strahler Spider 14ch / Conti MH 11ch / Klein Conti 7ch / Party Laser 7ch / Eurolite Großer Straler 5ch sind bereits als Builtin eingebaut.)
...
### ✅ P-02: Vorschau im RGB-Matrix-Bereich — ERLEDIGT (Audit 2026-06-12)
**Erledigt:** Seit dem Function-Umbau treibt die Vorschau ihre Phase per QTimer selbst
und liest bei jedem Tick live aus der Matrix → Parameteraenderungen sofort sichtbar.
Regression: `tests/test_rgb_matrix_view_controls.py`. (= open-points B-2.)
**Problem (historisch):** Die Effekt-Matrix-Vorschau zeigt nicht immer den korrekten Zustand an
...
### ✅ P-03: Start-/Stopp-Buttons im RGB-Matrix-Fenster — ERLEDIGT (Audit 2026-06-12)
**Erledigt:** `_start`/`_stop` (rgb_matrix_view.py) wirken auf die echte
FunctionManager-Instanz; Regressionstest in `tests/test_rgb_matrix_view_controls.py`.
(= open-points B-3.)
**Problem (historisch):** Die Steuer-Buttons (Start, Stopp und ggf. weitere) im RGB-Matrix-Fenster
...
### ✅ P-05: Matrix-Programmer – Kategorie-Auswahl oben — ERLEDIGT (Audit 2026-06-12)
**Erledigt:** Kategorie-Navigation im Programmer realisiert — erst als Kategorie-Leiste
(LAYOUT-03), dann zur einheitlichen Tab-Leiste konsolidiert (WP-5, `_make_attr_area`):
Intensity·Color·Position·Weitere + Helper·EFX·Matrix·Paletten. (= open-points U-2.)
**Ziel (historisch):** Im Matrix-Programmer soll der Nutzer oben zwischen verschiedenen
...
### ✅ P-08: Hilfe-Popups (Help-Tooltips) fuer Buttons im Programmer — ERLEDIGT 2026-06-14
**Erledigt:** „?"-Button in der Programmer-Toolbar aktiviert Qts „What's This?"-Modus;
Bedienelemente tragen Hilfetexte (`_PROGRAMMER_HELP` + `setWhatsThis`), die beim Klick
statt der Aktion als Sprechblase erscheinen (Esc beendet). `tests/test_programmer_help_mode.py`.
