...
- **BPM-Manager — Sub-Tab „Erkennung"** (Quelle · TAP mit Doppelrolle · Auto | Manuell · ×½/×2 · Erweitert: Tempo-Bereich, Vorlage, Beats/Takt, Beat-Latenz · **Generator**: ganzes Lied → Beatgrid, Analyse-Engines, Beatgrid-Editor, „Taktgenau"): [anleitung_bpm_manager/ANLEITUNG_BPM_MANAGER.md](anleitung_bpm_manager/ANLEITUNG_BPM_MANAGER.md)
