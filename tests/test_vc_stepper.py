"""Welle 3 / Cluster G: VCStepper (+/- Schrittzaehler) Widget.

Neues VC-Widget fuer ganzzahlige Zaehl-Parameter (runner_count/runner_width):
registriert, in der Galerie/Smart-Drop fuer PARAM angeboten, bindet wie der
Encoder an einen Effekt-Parameter und setzt ihn absolut + geklemmt.
"""
import os
...
class _Spec:
    def __init__(self, key="runner_count", lo=1, hi=16):
        self.key = key
        self.kind = "int"
        self.min = lo
        self.max = hi
